...
class FutureOrResult(Protocol):
    ...
    @overload
    def __call__(self, *args: Any, sync: Literal[True], **kwargs: Any) -> Any: ...

    @overload
    def __call__(self, *args: Any, sync: Literal[False], **kwargs: Any) -> Future[Any]: ...

    @overload
    def __call__(self, *args: Any, sync: bool = True, **kwargs: Any) -> Any: ...
